...
router.put('/:productId', product_controller_1.ProductControllers.getUpdatedProduct);
router.delete('/:productId', product_controller_1.ProductControllers.deletedProduct);
